...
function TimerPage() {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Ongoing slot */}
      {(() => {
        const isDanger = pace.feasible && pace.perSlot > 0 && minsLeftInSlot < pace.perSlot;
        return (
          <Card className={cn(
            "transition-all duration-300",
            isDanger && "border-2 border-danger/80 bg-gradient-to-br from-danger/8 via-surface to-danger/5 shadow-[0_0_24px_rgba(239,68,68,0.25)]"
          )}>
            ...
            <div className="mt-1.5 flex justify-between text-xs text-muted-foreground">
              ...
              <span>
                ...
                <strong className={cn(isDanger ? "text-danger" : "text-warning")}>
            ...
            <div
              className={cn(
                "mt-3 rounded-xl p-3 text-xs transition-all duration-300",
                isDanger 
                  ? "border-2 border-danger/50 bg-danger/8" 
                  : "bg-surface-2"
              )}
            >
